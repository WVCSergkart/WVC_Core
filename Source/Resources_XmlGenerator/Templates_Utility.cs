...
namespace WVC_UltraExpansion
{
	...
	namespace ImplantGenerator
	{
		...
		public static class TemplatesUtility
		{
			...
			{
				GetOrCreateStorageModFolders(out string path);
			...
			public static void Generator(ImplantGeneratorDef implantGeneratorDef, out List<ThingDef> thingDefs, out List<RecipeDef> recipeDefs, out List<HediffDef> hediffDefs)
			{
				...
				{
					GetFromTemplate_ThingDef(implantGeneratorDef.thingTemplateDef, bodyPartDef, implantGeneratorDef, out ThingDef thingDef);
					thingDefs.Add(thingDef);
					GetFromTemplate_HediffDef(implantGeneratorDef.hediffTemplateDef, bodyPartDef, thingDef, implantGeneratorDef, out HediffDef hediffDef);
					hediffDefs.Add(hediffDef);
					GetFromTemplate_SurgeryDef(implantGeneratorDef.surgeryTemplateDef, bodyPartDef, thingDef, hediffDef, implantGeneratorDef, out RecipeDef recipeDef);
					recipeDefs.Add(recipeDef);
				}
			}

			public static void GetOrCreateStorageModFolders(out string path)
			{
			...
			public static void GetFromTemplate_ThingDef(ThingTemplateDef template, BodyPartDef def, ImplantGeneratorDef implantGeneratorDef, out ThingDef thingDef)
			{
			...
			public static void GetFromTemplate_HediffDef(HediffTemplateDef template, BodyPartDef def, ThingDef thingDef, ImplantGeneratorDef implantGeneratorDef, out HediffDef hediffDef)
			{
			...
			public static void GetFromTemplate_SurgeryDef(SurgeryTemplateDef template, BodyPartDef def, ThingDef thingDef, HediffDef hediffDef, ImplantGeneratorDef implantGeneratorDef, out RecipeDef recipeDef)
			{
				recipeDef = new()
				{
